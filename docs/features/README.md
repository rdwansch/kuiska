...
Features 4–6 are implemented but retain their focused-test Definition of Done
items. Feature 7 is the next planned feature; its technical contract remains
business scope only.
